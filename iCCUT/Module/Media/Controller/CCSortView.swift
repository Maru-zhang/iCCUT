...
class CCSortView: UICollectionView,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    override func willMoveToSuperview(newSuperview: UIView?) {
        ...
        UIView.animateWithDuration(0.6, delay: 0, usingSpringWithDamping: 0.3, initialSpringVelocity: 0, options: UIViewAnimationOptions.LayoutSubviews, animations: { () -> Void in
